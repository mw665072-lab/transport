export const FREIGHT_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Zewar Transport focuses on cargo vans, Sprinter vans, box trucks, and hotshot transportation. The assigned equipment is confirmed against each shipment.",
  },
  {
    question: "Where does Zewar Transport operate?",
    answer:
      "Current stated coverage includes California, Texas, Nevada, and Virginia, plus surrounding interstate regions based on lane and driver availability.",
  },
  {
