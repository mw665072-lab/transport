...
export const EQUIPMENT: Equipment[] = [
  { name: "Cargo Vans", image: "/images/cargo-van.svg", description: "Enclosed, direct-delivery capacity for smaller commercial freight and urgent shipments.", specs: [
  ...
  { name: "Sprinter Vans", image: "/images/sprinter-van.svg", description: "Higher-roof enclosed vans for dedicated business freight needing more usable cargo space.", specs: [
    { label: "Approx. payload", value: "TODO: confirm fleet-specific payload" },
    { label: "Cargo length", value: "TODO: confirm fleet dimensions" },
    { label: "Liftgate", value: "Confirm assigned vehicle" },
  ]},
  { name: "Box Trucks", image: "/images/box-truck.svg", description: "Road-ready enclosed trucks for palletized and commercial regional/interstate freight.", specs: [
    { label: "Approx. payload", value: "TODO: confirm fleet-specific payload" },
